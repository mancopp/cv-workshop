<template>
  <div
    ref="zoomPinchEl"
    class="projection-wrapper flex flex-col justify-center items-center w-full h-screen p-5"
  >
    <zoompinch
      ref="zoompinchRef"
    ...
    >
      <template #canvas>
        <div
          class="w-[446px] bg-white text-black px-10 py-25 shadow-lg border-[1px]"
        >
          <h1 class="text-2xl">Test</h1>
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repellat,
            sunt eos fugit ducimus pariatur explicabo cum maxime nulla ut illum
            vel dolorum libero unde. Odit molestias recusandae velit impedit
            non?
          </p>
